...
export const NAV: NavItem[] = [
  ...
  { id: "sponsor-stack", label: "Sponsor stack", group: "Integrations" },
  { id: "twak-integration", label: "TWAK integration", group: "Integrations" },
  { id: "bnb-agent", label: "BNB Agent SDK", group: "Integrations" },
